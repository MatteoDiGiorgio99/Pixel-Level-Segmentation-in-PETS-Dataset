...
GAMMA = 0.1
DROPOUT_PROB = 0.1
DIRECTORY = f"runs/unet_AddDropoutAfterConv_{DROPOUT_PROB}"
DIRECTORY_CHECKPOINTS = f"runs/unet_AddDropoutAfterConv_{DROPOUT_PROB}/checkpoints"
...
save_model(m, f"unet_model_AddDropoutAfterConv_{DROPOUT_PROB}.pth")
