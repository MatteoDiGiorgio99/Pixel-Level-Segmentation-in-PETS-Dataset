...
GAMMA = 0.1
DROPOUT_PROB = 0.1
DIRECTORY = f"runs/unet_AddDropoutAfterReLU_{DROPOUT_PROB}"
DIRECTORY_CHECKPOINTS = f"runs/unet_AddDropoutAfterReLU_{DROPOUT_PROB}/checkpoints"
...
def conv_layer(input_channels, output_channels, dropout=True, dropout_prob=DROPOUT_PROB):
    layers = [
...
save_model(m, f"unet_model_AddDropoutAfterReLU_{DROPOUT_PROB}.pth")
