...
DIRECTORY = f"runs/unet_AdamStepLR0_01_{LEARNING_RATE}"
DIRECTORY_CHECKPOINTS = f"runs/unet_AdamStepLR0_01_{LEARNING_RATE}/checkpoints"
...
save_model(m, f"unet_model_Adam_{LEARNING_RATE}.pth")
