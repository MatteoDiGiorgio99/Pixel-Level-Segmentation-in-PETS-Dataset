...
EPOCHS = 50
LEARNING_RATE = 0.01
DIRECTORY = f"runs/unet_RMSprop_{LEARNING_RATE}"
DIRECTORY_CHECKPOINTS = f"runs/unet_RMSprop_{LEARNING_RATE}/checkpoints"
...
class UNet(nn.Module):
    def __init__(self, n_classes=3):  # Add n_classes as a parameter with a default value of 3
...
optimizer = torch.optim.RMSprop(m.parameters(), lr=LEARNING_RATE)
...
save_model(m, f"unet_model_RMSprop_{LEARNING_RATE}.pth")
