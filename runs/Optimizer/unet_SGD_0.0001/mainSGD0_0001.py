...
DIRECTORY = f"runs/unet_SGD_{LEARNING_RATE}"
DIRECTORY_CHECKPOINTS = f"runs/unet_SGD_{LEARNING_RATE}/checkpoints"
...
save_model(m, f"unet_model_SGD_{LEARNING_RATE}.pth")
